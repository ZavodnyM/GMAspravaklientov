...
##      entryMeno.bind("<Return>", pridaj_klienta)
...
##      entryPriezvisko.bind("<Return>", pridaj_klienta)
...
##      entryRodnecislo.bind("<Return>", pridaj_klienta)
...
def vypis_info():
      ...
      buttonpridatucet = tkinter.Button(text='Pridať účet',font="Helvetica 10",command = None,height = 2,width = 10)
